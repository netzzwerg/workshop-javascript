...
var Stats = function() {
    ...
    _fpsText,
    _fpsGraph,
    _fpsColors = [[48, 48, 48], [47, 161, 214]],
    _ms = 0,
    _msMin = 1000,
    _msMax = 0,
    _msDiv,
    _msText,
    _msGraph,
    _msColors = [[48, 48, 48], [163, 157, 19]];

    _container = document.createElement('div');
    _container.style.cursor = 'pointer';
    _container.style.width = '100px';
    _container.style.zIndex = '10001';
    _container.style.position = 'absolute';
    _container.style.left = '50px';
    _container.style.top = '50px';
    ...
    _fpsText.className = 'dg';
    _fpsText.style.padding = '0 0 5px 0px';
    ...
    _msText.className = 'dg';
    _msText.style.padding = '0 0 5px 0px';
